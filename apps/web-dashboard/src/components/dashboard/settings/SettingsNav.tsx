...
export function SettingsNav() {
    ...
    const settingsLinks = [
        ...
        { href: "/dashboard/settings/gallery", label: (t.settings as any).gallery ?? "Galerie", icon: Images },
        { href: "/dashboard/settings/themes", label: "Themes", icon: LayoutGrid },
        { href: "/dashboard/settings/tracking", label: "Pixels & Analytics", icon: BarChart3 },
