...
export function Hero() {
    ...
    const copy = locale === "fr"
        ? {
            ...
            description:
                "Gérez vos commandes sans effort. Un menu digital attrayant, des paiements Mobile Money automatiques et une gestion simplifiée. Laissez tomber le papier.",
            placeholder: "Nom de votre établissement",
            cta: "Créer mon espace",
            ctaSub: "Testez gratuitement — Sans carte bancaire",
            proofStrip: ["Zéro commission", "En ligne en 2 min", "MoMo Intégré"],
            stats: [
        ...
        : {
            ...
            description:
                "Manage your orders effortlessly. Beautiful digital menus, automatic MoMo payments, and simplified operations. Leave the paper behind.",
            placeholder: "Your business name",
            cta: "Create my space",
            ctaSub: "Try for free — No credit card required",
            proofStrip: ["Zero commission", "Online in 2 mins", "MoMo Integrated"],
            stats: [
                { value: "0%", label: "commission" },
