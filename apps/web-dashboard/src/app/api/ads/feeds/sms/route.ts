/**
 * GET /api/ads/feeds/sms — Fetch MTN SMS advertising feeds.
 *
...
import { getSmsFeed, isMtnAdsConfigured } from "@/lib/ads/mtn";
...
export async function GET(request: NextRequest) {
    try {
        ...
        const feed = await getSmsFeed(params);
        ...
        console.error("GET /api/ads/feeds/sms error:", error);
        return apiError(
