    ...
    try {
        ...
        try {
            switch (platform) {
                ...
                case "tiktok":
                    // TikTok Content Posting API requires video — save as draft for manual posting
                    publishError = "Publication TikTok automatique non disponible. Utilisez le contenu genere pour poster manuellement.";
                    break;

                case "whatsapp":
                    // WhatsApp Business Cloud API
                    publishError = "Publication WhatsApp automatique bientot disponible. Contenu sauvegarde.";
                    break;
            }
        } catch (err) {
