...
import { ApiCacheProvider } from '@/contexts/api-cache-context';
                            ...
                            <CartProvider>
                                <FavoritesProvider>
                                    <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
                                        {/* Conteneur relatif nécessaire pour que le bandeau absolu se positionne correctement */}
                                        <View style={{ flex: 1 }}>
                                            {/* Bandeau hors-ligne — visible sur tous les écrans */}
                                            <OfflineBanner />
                                            <Stack>
                                                ...
                                                <Stack.Screen name="profile/account-verification" options={{ headerShown: false }} />
