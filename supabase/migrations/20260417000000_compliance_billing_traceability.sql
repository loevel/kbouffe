...
-- ---------------------------------------------------------------------------
-- 1) TVA mensuelle : déclaration immuable avec preuve de dépôt
-- ---------------------------------------------------------------------------
...
ALTER TABLE IF EXISTS public.tva_declarations
    ADD COLUMN IF NOT EXISTS filing_snapshot JSONB NOT NULL DEFAULT '{}'::jsonb;
ALTER TABLE IF EXISTS public.tva_declarations
...
-- ---------------------------------------------------------------------------
-- 2) Payouts : colonnes de référence + historique des événements immuable
-- ---------------------------------------------------------------------------
