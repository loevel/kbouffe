            ...
            <div className="flex items-center gap-1">
                ...
                <Dropdown
                    items={[
                        ...
                        { label: t.topbar.signOut, onClick: () => signOut(), variant: "danger" },
                    ]}
                    trigger={
                        <div className="w-9 h-9 rounded-full bg-brand-500/10 flex items-center justify-center text-brand-500 font-bold text-sm cursor-pointer hover:bg-brand-500/20 transition-colors">
